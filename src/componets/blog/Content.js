                ...
                <div className="recent-news">
                  ...
                  <div className="info-bx">
                    <ul className="media-post">
                      <li>
                        <a href="#">
                          <i className="fa fa-calendar"></i>Feb 05 2019
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="fa fa-user"></i>By John
                        </a>
                      </li>
                    </ul>
                    <h5 className="post-title">
                    ...
                    <div className="post-extra">
                      ...
                      <a href="#" className="comments-bx">
                        <i className="fa fa-comments-o"></i>14 Comment
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="recent-news">
                  ...
                  <div className="info-bx">
                    <ul className="media-post">
                      <li>
                        <a href="#">
                          <i className="fa fa-calendar"></i>April 14 2019
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="fa fa-user"></i>By George
                        </a>
                      </li>
                    </ul>
                    <h5 className="post-title">
                    ...
                    <div className="post-extra">
                      ...
                      <a href="#" className="comments-bx">
                        <i className="fa fa-comments-o"></i>23 Comment
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="recent-news">
                  ...
                  <div className="info-bx">
                    <ul className="media-post">
                      <li>
                        <a href="#">
                          <i className="fa fa-calendar"></i>March 21 2019
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="fa fa-user"></i>By Thomas
                        </a>
                      </li>
                    </ul>
                    <h5 className="post-title">
                    ...
                    <p>
                      When I needed to start from scratch and figure out how
                      things work. Getting people.
                    </p>
                    <div className="post-extra">
                      <a href="#" className="btn-link">
                        READ MORE
                      ...
                      <a href="#" className="comments-bx">
                        <i className="fa fa-comments-o"></i>28 Comment
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="recent-news">
                  ...
                  <div className="info-bx">
                    <ul className="media-post">
                      <li>
                        <a href="#">
                          <i className="fa fa-calendar"></i>May 08 2019
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="fa fa-user"></i>By James
                        </a>
                      </li>
                    </ul>
                    <h5 className="post-title">
                    ...
                    <p>
                      Honestly, I made ZERO money in the first year and I
                      definitely do not want you to go.
                    </p>
                    <div className="post-extra">
                      <a href="#" className="btn-link">
                        READ MORE
                      ...
                      <a href="#" className="comments-bx">
                        <i className="fa fa-comments-o"></i>26 Comment
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="recent-news">
                  ...
                  <div className="info-bx">
                    <ul className="media-post">
                      <li>
                        <a href="#">
                          <i className="fa fa-calendar"></i>June 19 2019
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="fa fa-user"></i>By Arthur
                        </a>
                      </li>
                    </ul>
                    <h5 className="post-title">
                    ...
                    <p>
                      You may have seen our tool that's been featured by many
                      world-className SEO marketers.
                    </p>
                    <div className="post-extra">
                      <a href="#" className="btn-link">
                        READ MORE
                      ...
                      <a href="#" className="comments-bx">
                        <i className="fa fa-comments-o"></i>15 Comment
                      </a>
                    </div>
                  </div>
                </div>
